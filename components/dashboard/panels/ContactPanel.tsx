    ...
    <div className="p-8 max-w-4xl">
      ...
      <div className="grid md:grid-cols-2 gap-3 mb-6">
        <a
          ...
          className="bg-bg-primary border border-border hover:border-accent-blue rounded-lg p-5 transition-colors group"
        >
        ...
        <a
          ...
          className="bg-bg-primary border border-border hover:border-accent-green rounded-lg p-5 transition-colors group"
        >
          <div className="flex items-center gap-3 mb-1">
            <span className="text-xl">📞</span>
        ...
        <a
          ...
          className="bg-bg-primary border border-border hover:border-purple-400 rounded-lg p-5 transition-colors group md:col-span-2"
        >
          <div className="flex items-center gap-3 mb-1">
            <span className="text-xl">📝</span>
